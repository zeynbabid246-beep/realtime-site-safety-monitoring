...
try:
    ...
    logger.warning("Could not load hazard model (%s). Falling back to DummyHazardDetector.", exc)
...
try:
    ...
    logger.warning("Could not load fire/smoke model (%s). Falling back to DummyFireDetector.", exc)
